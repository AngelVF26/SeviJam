...
const OBJETOS = {
	...
	"ROCAS" : {
		"OBJECTMSG" : "Muestra inorgánica obtenida. Inicie [color=white]ANÁLISIS[/color] para examinarla.",
	...
	"PLANTA" : {
		"OBJECTMSG" : "Muestra de ADN obtenida. Inicie [color=white]ANÁLISIS[/color] para examinarla.",
...
const COMANDOS = {
	["mover", "desplazar", "avanzar", "/mover", "/desplazar", "/avanzar"]: {
		"commandname": "MOVER",
		"nombre_nodo": "Mover",
		"commanddescription": ". . . Movimiento finalizado. Revisar MAPA para comprobar \n posición.",
